          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{asset('theme/adminlte/img/bus1.jpg')}}" class="img-circle" alt="User Image">

                <p>
                  Bus Cute - Pet pet pet
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="\home" class="btn btn-default btn-flat">Đăng xuất</a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{asset('theme/adminlte/img/bautroi.jpg')}}" class="img-circle" alt="User Image">
        </div>
